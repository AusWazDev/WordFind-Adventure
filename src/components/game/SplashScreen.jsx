...
// ── SplashScreen ──────────────────────────────────────────────────────────────
// Shows on every cold app launch. Sequence: fade in (400ms) → hold (2000ms) →
// fade out (300ms) → calls onComplete so the Home screen takes over.
// Design mirrors the approved CR-19 mockup:
//   Background : deep dark near-black (#0f0e1a → #1a1830)
//   Icon       : public/icon.png (1024px master, displayed with rounded corners)
//   Name       : "Sound" (white) + "Find" (violet-400)
//   Tagline    : "Find the words. Feel the sound."
//   Loader     : three soft violet dots
// ─────────────────────────────────────────────────────────────────────────────
