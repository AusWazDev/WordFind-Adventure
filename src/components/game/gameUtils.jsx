...
const wordClues = {
  ...
  ATMOSPHERE:'The layer of gases enveloping a planet, held in place by gravity',
  ...
  DATA:'Raw facts, figures or signals that can be stored, processed and analysed',
  ...
  MEMORY:'The component of a computer that stores data and instructions for the processor to access',
  ...
  LORD:'A feudal noble who held land granted by a king in exchange for military service',
  ...
  SUNLIGHT:'The visible light and radiation emitted by the Sun that illuminates Earth',
