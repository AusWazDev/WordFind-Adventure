...
const wordClues = {
  ...
  MOLE:'Tiny burrowing mammal with velvety fur and huge front claws',SPARROW:'Small common songbird found almost worldwide',
  ...
  CORAL:'A warm orange-pink named after sea coral',BEIGE:'A pale sandy neutral tone',
  ...
  MAGENTA:'A vivid purplish-pink used in colour printing',LIME:'A bright yellow-green like unripe citrus',
  NAVY:'A very dark blue, colour of naval uniforms',OLIVE:'A dull yellowish-green like unripe olives',
  AMBER:'A warm golden-orange like tree resin',PEACH:'A soft pinkish-orange named after the fruit',
  ...
  CREAM:'A warm off-white like fresh dairy cream',AQUA:'A bright blue-green like clear tropical water',
  ...
  MUFFIN:'A small domed individual cake or bread roll',COOKIE:'A flat sweet biscuit baked until crisp',
  SALMON:'A large pink-fleshed fish rich in omega-3',SHRIMP:'A small shellfish cooked and eaten whole or peeled',
  NOODLE:'A long thin strip of pasta or dough used in Asian cooking',LEMON:'A sour yellow citrus fruit',
  MELON:'A large round fruit with sweet watery flesh',PEACH:'A soft fuzzy-skinned stone fruit with sweet flesh',
  OLIVE:'A small salty fruit pressed for its oil or eaten whole',ONION:'A pungent layered bulb used as a cooking base',
  ...
  BUTTER:'A rich dairy spread made from churned cream',CREAM:'The fatty layer skimmed from fresh milk',
  ...
  MOUNTAIN:'A large natural elevation of the Earth\'s surface',FOREST:'A dense area of trees covering a large area',
  DESERT:'An arid region with very little rainfall',LAKE:'A large body of still water surrounded by land',
  CLOUD:'A mass of water droplets floating in the atmosphere',RAIN:'Water falling from clouds to the ground',
  ...
  WATERFALL:'Water cascading over a cliff edge',ISLAND:'A piece of land completely surrounded by water',
  ...
  SPRING:'A place where water naturally bubbles up from the ground',STREAM:'A small narrow body of flowing water',
  ...
  ASTEROID:'A rocky body orbiting the Sun, mostly found in the asteroid belt',GRAVITY:'The invisible force pulling all matter together',
  ECLIPSE:'When one celestial body passes in front of another',SOLSTICE:'The longest or shortest day of the year',
  EQUINOX:'When day and night are equal length — spring or autumn',AURORA:'Colourful light display near the poles caused by solar wind',
  ...
  GREECE:'Southern European country, birthplace of democracy and the Olympics',TURKEY:'A transcontinental country linking Europe and Asia',
  ...
  FOSSIL:'Preserved remains of ancient organisms found in rock',EROSION:'The gradual wearing away of rock or soil by natural forces',
  ...
  GRAVITY:'The force of attraction between all objects with mass',MOMENTUM:'The product of an object\'s mass and velocity',
  VELOCITY:'Speed in a specified direction',CATALYST:'A substance that speeds up a chemical reaction without being consumed',
  POLYMER:'A long chain molecule made from repeating smaller units',CRYSTAL:'A solid with atoms arranged in a regular repeating structure',
  ...
  KRAKEN:'A legendary colossal sea monster of Scandinavian myth',TITAN:'A race of powerful deities in Greek mythology, predecessors of the Olympians',
  ...
  CLOUD:'Remote computer servers accessed via the internet',PIXEL:'The smallest individual element in a digital image',
  ...
  STREAM:'Transmitting data continuously in real time over the internet',UPLOAD:'Sending data from your device to a remote server',
  ...
  // ── Ocean ─────────────────────────────────────────────────────────────────
  WAVE:'A moving ridge of water on the surface of the ocean',CORAL:'Marine invertebrates forming colourful reef structures',
  REEF:'An underwater ridge of rock or coral near the surface',TIDE:'The rise and fall of the sea caused by the Moon\'s gravity',
  ...
  LOBSTER:'A large clawed marine crustacean prized as seafood',SQUID:'A fast-moving cephalopod with ten tentacles',
  CLAM:'A bivalve mollusc that filters water through its shell',OYSTER:'A bivalve that can produce a pearl inside its shell',
  ...
  PENGUIN:'A flightless bird perfectly adapted for swimming in cold oceans',PELICAN:'A large seabird with an enormous bill pouch for catching fish',
  ...
  LAGOON:'A shallow saltwater lake separated from the ocean by a reef or sandbar',ATOLL:'A ring-shaped coral island surrounding a lagoon',
  ...
  PHARAOH:'An ancient Egyptian king who was considered a god',KNIGHT:'An armoured medieval warrior who served a lord',
  CASTLE:'A large fortified medieval residence',SIEGE:'A military blockade to force surrender of a town or fort',
  ...
  TOMB:'A burial chamber or monument for the dead',BURIAL:'The ritual placing of a deceased person in a grave',
  ...
  CATAPULT:'An ancient siege weapon that launches heavy projectiles',ARMOUR:'Protective clothing worn by soldiers in battle',
  SHIELD:'A hand-held defence used to block attacks in combat',SWORD:'A bladed weapon with a long cutting edge',
  ...
  ANGRY:'Feeling strong displeasure or hostility',CALM:'Peaceful and free from agitation',
  ...
  DESPERATE:'Feeling that the situation is hopeless and urgent',PEACEFUL:'Free from disturbance or conflict',

  // ── Tricky audio words ────────────────────────────────────────────────────
  KNIGHT:'An armoured medieval warrior — the K is silent',KNEEL:'To go down on one or both knees — the K is silent',
  ...
  LAMB:'A young sheep — the B is silent',THUMB:'The short thick first digit of the hand — the B is silent',
  ...
  TOMB:'A burial chamber — the B is silent',WOMB:'The organ where babies develop — the B is silent',
  ...
  CASTLE:'A large fortified medieval building — the T is silent',WHISTLE:'A shrill sound made by forcing air through lips — the T is silent',
  ...
  HONOUR:'Great respect and good reputation — the H is silent',RHYME:'Words that end with the same sound — the H is silent',
  ...
  CALM:'Peacefully free from disturbance — the L is silent',PALM:'The inner surface of the hand — the L is silent',
  ...
  YOLK:'The yellow part of an egg — the L is silent',SALMON:'A pink-fleshed fish — the L is silent',
  ALMOND:'A nutritious tree nut — the L is silent',
  SWORD:'A bladed weapon with a long edge — the W is silent',ANSWER:'A reply to a question — the W is silent',
  ISLAND:'A piece of land surrounded by water — the S is silent',YACHT:'An elegant sailing vessel — the CH is silent',
  ...
  VIGOUR:'Physical or mental strength — British spelling with the U',ARMOUR:'Protective body covering — British spelling with the U',
  ...
  SURPRISE:'An unexpected event — ends in -ise',
  ...
  SCISSORS:'A cutting tool — double S and silent C',SEPARATE:'To divide — people often misspell it "seperate"',
  ...
  DEFINITELY:'Without any doubt — often misspelled "definately"',DESPERATE:'Feeling that the situation is hopeless — often misspelled "desparate"',
  ...
  CAMEL:'A warm tan like a camel\'s coat',
  ...
  FOREST:'A dark rich green like dense woodland',
  ...
  PEACOCK:'A rich blue-green like the bird\'s iridescent feathers',
  ...
  LAMB:'The tender meat of a young sheep',
  LEEK:'A mild onion-family vegetable with a long white stalk',
  LIME:'A small green citrus fruit sourer than a lemon',
  ...
  MOLE:'A unit in chemistry representing approximately 6.02 × 10²³ particles',
  ...
  COOKIE:'A small file stored by a website on your device to remember your preferences',
  ...
  CLUSTER:'A group of servers that work together as a single distributed system',
  ...
  TITAN:'Saturn\'s largest moon — the only moon with a thick atmosphere and liquid lakes',
  ...
  CLUSTER:'A gravitationally bound group of stars or galaxies',
